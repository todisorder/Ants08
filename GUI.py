...
AllParameters = [
                 ...
                 "NaturalVelocity(SENSING_AREA_RADIUS*cos(SensingAreaHalfAngle))",False),
                 OneParameter("static double const","LambdaNonlocal",\
                 "(3./2.)*NaturalVelocity*SensingAreaHalfAngle/(SENSING_AREA_RADIUS*sin(SensingAreaHalfAngle))",False),
...
window.bind("<Return>",write_cpp_file)

btn = Button(window, text="Click Me or press Return", command=write_cpp_file)
